...
<img src="/images/blog/astro/astro-2-0-content-collections.webp" alt="A screenshot of the TypesScript code needed to define Astro's content collections." />
...
<img src="/images/blog/astro/astro-2-0-error-comparison.webp" alt="A side-by-side comparison of Astro's new and old errors. The Astro 1.0 errors are on the left and the Astro 2.0 errors are on the right." />
...
<img src="/images/blog/generic/roadmap.webp" alt="A road cutting between trees in a forest." />
