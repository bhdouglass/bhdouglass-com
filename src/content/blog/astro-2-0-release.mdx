...
updatedDate: 2024-12-06T16:10:12.433Z
categories:
  - astro
...
relatedPosts:
  ...
  - built-with-astro
---
Update: Version 2.0 is old news, check out [Astro 4.0](../astro-4-0-release/) and [Astro 5.0](../astro-5-0-release/)!
...
![A screenshot of the TypesScript code needed to define Astro's content collections.](/images/blog/astro/astro-2-0-content-collections.webp)
...
![A side-by-side comparison of Astro's new and old errors. The Astro 1.0 errors are on the left and the Astro 2.0 errors are on the right.](/images/blog/astro/astro-2-0-error-comparison.webp)
...
![A road cutting between trees in a forest.](/images/blog/generic/roadmap.webp)
