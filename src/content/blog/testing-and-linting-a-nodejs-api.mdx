...
categories:
  - nodejs
  - tutorial
image: /images/blog/nodejs-testing-mocha.webp
...
<InfoBlock>
  This post is quite old, but may be still relevant to you. However, if you are looking
  for something more modern, check out my post about [testing an Express app with the Node Test Runner](/blog/test-an-expressjs-app-with-nodetest/).
</InfoBlock>
...
particular? Mostly due to familiarity from a previous job. This approach is working
