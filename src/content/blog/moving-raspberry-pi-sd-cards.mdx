...
categories:
  - raspberry-pi
image: /images/blog/raspberry-pi/raspberry-pi-sd-card.webp
...
![The output of the terminal command "lsblk -p"](/images/blog/raspberry-pi/lsblk-p.webp)
...
![The output of the terminal command "dd"](/images/blog/raspberry-pi/dd.webp)
...
![The Raspberry Pi 4 Model B Small Board Computer](/images/blog/raspberry-pi/raspberry-pi-4.webp)
