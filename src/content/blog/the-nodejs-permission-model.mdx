...
updatedDate: 2026-03-07T04:10:47.326Z
categories:
  - nodejs
  - tutorial
...
This flag allows http requests to be made.
This is available in [Node.js version 25.0.0](https://nodejs.org/en/blog/release/v25.0.0)
...
[Node.js v25.8.0](https://nodejs.org/en/blog/release/v25.8.0) introduces the
...
- [Node.js version 25.8.0 release announcement](https://nodejs.org/en/blog/release/v25.8.0)
